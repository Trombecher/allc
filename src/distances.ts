...
export const distanceCMClc = (
    ...
    const t =
        2.8623399732707004 <= h1Normalized && h1Normalized <= 6.021385919380437
            ? 0.56 + Math.abs(0.2 * Math.cos(h1Normalized + 2.9321531433504737)) // Constant value `Math.PI * 168 / 180`
            : 0.36 +
              Math.abs(0.4 * Math.cos(h1Normalized + 0.6108652381980153)); // Constant value `Math.PI * 35 / 180`
...
export const distanceCIE94 = (
    ...
    return Math.hypot(
        (l2 - l1) / kl,
        (c2 - c1) / (kc * (1 + K1 * c1)),
        Math.hypot(a2 - a1, b2 - b1, c2 - c1) / (kh * (1 + K2 * c1)),
    );
};
...
export const distanceCIEDE2000 = (
    ...
    */
    ...
    const deltaHDash =
        2 *
        Math.sqrt(c1Dash * c2Dash) *
        Math.sin((Math.PI * (a1Dash - a2Dash)) / 360);
    ...
    const rt =
        -2 *
        Math.sqrt(cAverage ** 7 / (cAverage ** 7 + 25 ** 7)) *
        // Constant values `275 * Math.PI / 180` and `25 * Math.PI / 180`
        Math.sin(
            (Math.PI / 3) *
                Math.exp(
                    -(
                        ((hDashAverage - 4.799655442984406) /
                            0.4363323129985824) **
                        2
                    ),
                ),
