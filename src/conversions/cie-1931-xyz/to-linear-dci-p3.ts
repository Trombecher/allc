 ...
 */
export const toLinearDCIP3RFromCIE1931XYZ = (x: number, y: number, z: number) =>
    clamp01(
        x * MATRIX_LINEAR_DCI_P3_FROM_CIE_1931_XYZ_0_0 +
 ...
 */
export const toLinearDCIP3GFromCIE1931XYZ = (x: number, y: number, z: number) =>
    clamp01(
        x * MATRIX_LINEAR_DCI_P3_FROM_CIE_1931_XYZ_1_0 +
 ...
 */
export const toLinearDCIP3BFromCIE1931XYZ = (x: number, y: number, z: number) =>
    clamp01(
        x * MATRIX_LINEAR_DCI_P3_FROM_CIE_1931_XYZ_2_0 +
