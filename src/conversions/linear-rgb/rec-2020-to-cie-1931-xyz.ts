import {
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_REC_2020_0_0,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_REC_2020_0_1,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_REC_2020_0_2,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_REC_2020_1_0,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_REC_2020_1_1,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_REC_2020_1_2,
 ...
 *
 * @param r The red component of linear Rec. 2020, typically in the range [0, 1].
 * @param g The green component of linear Rec. 2020, typically in the range [0, 1].
 * @param b The blue component of linear Rec. 2020, typically in the range [0, 1].
 *
 * @returns The X component of CIE 1931 XYZ.
 */
export const toCIE1931XYZXFromLinearRec2020 = (
    r: number,
    g: number,
    b: number,
 ...
 */
export const toCIE1931XYZYFromLinearRec2020 = (
    r: number,
    g: number,
    b: number,
 ...
 */
export const toCIE1931XYZZFromLinearRec2020 = (
    r: number,
    g: number,
    b: number,
