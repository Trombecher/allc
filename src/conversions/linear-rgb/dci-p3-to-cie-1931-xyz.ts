...
import {
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_0_0,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_0_1,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_0_2,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_1_0,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_1_1,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_1_2,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_2_0,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_2_1,
    MATRIX_CIE_1931_XYZ_FROM_LINEAR_DCI_P3_2_2,
} from "../../matrices";

/**
 * Calculates the X component of CIE 1931 XYZ from linear DCI-P3.
 *
 * @param r The red component of linear DCI-P3, typically in the range [0, 1].
 * @param g The green component of linear DCI-P3, typically in the range [0, 1].
 * @param b The blue component of linear DCI-P3, typically in the range [0, 1].
 *
