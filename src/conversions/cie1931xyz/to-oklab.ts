 ...
 */
export const toLMSDashComponentFromLMSComponent = (
    component: number,
) => Math.cbrt(component);
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toLMSLFromCIE1931XYZ = (
    x: number,
    y: number,
    z: number,
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toLMSMFromCIE1931XYZ = (
    x: number,
    y: number,
    z: number,
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toLMSSFromCIE1931XYZ = (
    x: number,
    y: number,
    z: number,
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toOklabLFromLMSDash = (
    l: number,
    m: number,
    s: number,
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toOklabAFromLMSDash = (
    l: number,
    m: number,
    s: number,
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toOklabBFromLMSDash = (
    l: number,
    m: number,
    s: number,
