 ...
 */
export const toLMSComponentFromLMSDashComponent = (component: number) =>
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toLMSDashLFromOklab = (l: number, a: number, b: number) =>
    l * 0.99999999845052 + a * 0.396337792173768 + b * 0.215803758060759;
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toLMSDashMFromOklab = (l: number, a: number, b: number) =>
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toLMSDashSFromOklab = (l: number, a: number, b: number) =>
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toCIE1931XYZXFromLMS = (l: number, m: number, s: number) =>
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toCIE1931XYZYFromLMS = (l: number, m: number, s: number) =>
    l * -0.040580178423281 + m * 1.11225686961683 + s * -0.071676678665601;
 ...
 * @see https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
 */
export const toCIE1931XYZZFromLMS = (l: number, m: number, s: number) =>
