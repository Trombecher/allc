...
export const toLinear${pascalcase}RFromCIE1931XYZ = (
    ...
    y: number,
    z: number,
) => x * MATRIX_LINEAR_${uppercase}_FROM_CIE_1931_XYZ_0_0
...
export const toLinear${pascalcase}GFromCIE1931XYZ = (
    ...
    y: number,
    z: number,
) => x * MATRIX_LINEAR_${uppercase}_FROM_CIE_1931_XYZ_1_0
...
export const toLinear${pascalcase}BFromCIE1931XYZ = (
    ...
    y: number,
    z: number,
) => x * MATRIX_LINEAR_${uppercase}_FROM_CIE_1931_XYZ_2_0
...
const addRGBColorSpace = async (
    ...
    addSquareMatrix(`LINEAR_${uppercase}_FROM_CIE_1931_XYZ`, inverse(linearRGBToCIE1931XYZMatrix).to1DArray());

    await Promise.all([
        writeFile(
            `./src/conversions/cie-1931-xyz/to-linear-${filecase}.ts`,
            fileTextToLinearRGBColorSpaceFromCIE1931XYZ(uppercase, text, pascalcase),
        ),
        writeFile(
            `./src/conversions/linear-rgb/${filecase}-to-cie-1931-xyz.ts`,
            fileTextToCIE1931XYZFromLinearRGBColorSpace(uppercase, text, pascalcase),
        ),
    ]);
};
...
await writeFile("./src/matrices/generated.ts", "// This file was automatically generated by `src-comptime/precalculate.ts` in the root of the repo.\n" + Array.from(constants
    .entries())
